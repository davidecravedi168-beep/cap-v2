...
export const MODEL_BOARD_VERSION='2026-09-15-v3';
...
export const ROLE_MODEL_BOARD={
  Direttore:{purpose:'orchestrazione e sintesi',route:[B('nvidia/nemotron-3-ultra-550b'),V()]},
  Lumen:{purpose:'ricerca sui materiali forniti e verifica',route:[B('nvidia/nemotron-3.5-lightning'),B('nvidia/nemotron-3-ultra-550b'),V()]},
  ...
  Sage:{purpose:'strategia e scenari',route:[B('nvidia/nemotron-3-ultra-550b'),B('nvidia/nemotron-3.5-lightning'),V()]},
